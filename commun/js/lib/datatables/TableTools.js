...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Tableau copié</h6>'+
				'<p>'+lines+' ligne'+plural+' dans le presse-papier.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vue d'impression</h6><p>Merci d'utiliser les fonctionnalités du navigateurs pour imprimer "+
		  "ce tableau. Appuyer sur échap lorsque vous avez terminé.</p>",
		"sMessage": null,
		"bShowAll": true,
		"sToolTip": "Vue d'impression",
