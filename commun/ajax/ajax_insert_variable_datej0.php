...
if( isset($_GET['id_var']) ){
  ...
  if($new_id!=''){
    ...
    $delete_current_id = ORM::for_table('variables')->where_equal('id_etude',$id_etude['id_etude'])->where('cle','J0')->find_one();
    ...
    $insert_new_id->cle= 'J0';
    $insert_new_id->save();
    
    $b_ajax['error'] = false;
    $b_ajax['message'] = 'Mise à jour Variable date J0 avec succéé';
