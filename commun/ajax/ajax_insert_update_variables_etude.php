    ...
    if($etude == false){
        ...
        for ($row = 3; $row <= $highestRow; $row++) {
           ...
           if($variable or $libelle){
            ...
            $var = ORM::for_table('variables')->create();
        ...
        $b_ajax['message'] = "La nouvelle etude est bien enregistré." ;
        $b_ajax['message'] .= " Nombre des variables inserées :".$nombre_variables_inseres;
        ...
        $b_ajax['message'] = "Mise a jour avec sucssé." ;
        $b_ajax['message'] .= " Nombre des variables inserées :".$nombre_variables_inseres;
        $b_ajax['message'] .= " Nombre des variables mis à jour :".$nombre_variables_updated;
        $b_ajax['message'] .= " Nombre des lignes vide :".$nombre_lignes_vides;
        $b_ajax['error'] = false;
    }
}else{
