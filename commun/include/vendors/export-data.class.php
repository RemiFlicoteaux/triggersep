...
/**
 * ------------------------- ! IMPORTANT ! ------------------------------------------
 * modification par elbaz michael le 21 juillet 2015 ne pas mettre a jour cette classe
 * desactivation du type des cellules dans la methode generateCell (ligne 207)
 */
...
class ExportDataExcel extends ExportData {
    ...
    //suppression de la condition pour les dates par elbaz michael
    /*
